        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="contact-form">
                      <?php
                      if(isset($_SESSION['guest_message_succ'])):
                      ?>
                      <small class="text-success"><?=$_SESSION['guest_message_succ']?></small>
                      <?php
                        unset($_SESSION['guest_message_succ'])
                      ?>
                      <?php
                      endif
                      ?>
              <form id="contact" action="admin/guest_message/guest_message_post.php" method="post">
                <div class="row">
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      ...
                      ?>
                      <small><?= $_SESSION['guest_name_err']?></small>
                      <?php
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      ...
                      ?>
                      <small><?= $_SESSION['guest_email_err']?></small>
                      <?php
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      ...
                      ?>
                      <small><?= $_SESSION['guest_subject_err']?></small>
                      <?php
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      ...
                      ?>
                      <small><?= $_SESSION['guest_message_err']?></small>
                      <?php
